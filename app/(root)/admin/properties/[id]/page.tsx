...
export default function EditPropertyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axiosWithAuth().put(`/properties/${id}`, payload);
  ...
  return (
    <div className="w-full lg:w-4/5 mx-auto py-20 px-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
        ...
        <input type="text" name="size" placeholder="Size" value={form.size} onChange={handleChange} className="border w-full p-2 rounded" />
